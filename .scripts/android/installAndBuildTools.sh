...
function listVariables() {
  ...
  ANDROID_PLACE=${ANDROID_PLACE};
  ANDROID_SDK=${ANDROID_SDK};
  ANDROID_HOME=${ANDROID_HOME};
  ANDROID_TOOLS_BIN=${ANDROID_TOOLS_BIN};
  SDK_MANAGER=${SDK_MANAGER};
  ANDROID_LICENSES=${ANDROID_LICENSES};
  SDK_LICENSE=${SDK_LICENSE};
  ENV_FILE=${ENV_FILE};
  TMP_PLUGIN_LIST=${TMP_PLUGIN_LIST};
  PLUGIN_NAME=${PLUGIN_NAME};
  PLUGIN_NUM=${PLUGIN_NUM};
  SDK_TOOLS_ZIP=${SDK_TOOLS_ZIP};
  BUILD_TOOLS_VERSION=${BUILD_TOOLS_VERSION};
  PLATFORM_TOOLS_VERSION=${PLATFORM_TOOLS_VERSION};
  SDK_PLATFORM_TOOLS=${SDK_PLATFORM_TOOLS};
...
export BUILD_TOOLS_VERSION=26.0.2;

export SDK_PLATFORM="android-25";
export SDK_PLATFORM_TOOLS="platform-tools";
export SDK_BUILD_TOOLS="build-tools;${BUILD_TOOLS_VERSION}";
export SDK_PLATFORM_ANDROID_711_API_25="platforms;${SDK_PLATFORM}";
...
" > ${SDK_LICENSE};
  ...
  getPlugin "${SDK_PLATFORM_ANDROID_711_API_25}" ${ANDROID_HOME}/platforms/${SDK_PLATFORM}/package.xml;
